...
| T-032 | in progress | UIX-007/003 | M | 2026-07-29 | Dispatched. |
| T-033 | pending | UIX-005/006/011 | M | — | |
| T-034 | in progress | UIX-004/012/013 | M | 2026-07-29 | Dispatched. |
| T-035 | **partial** | UIX-002 + batch | M | 2026-07-29 | 6 of 8 client-state defects fixed, one commit each, all falsified (tone rollback; lore snapshot adoption; steward ledger-read; reaction serialization; realtime retry handle + online reconnect; clipboard outcome). 9 tests. **Data Book restore + onboarding deselected-league re-check still open** — my agent brief listed only 6 of the card's 8 items. |
