...
Keep it current. Last updated: 2026-06-16 — **Phase 4 token accessibility gates landed** with registered-theme contrast checks and reduced-motion token coverage.
