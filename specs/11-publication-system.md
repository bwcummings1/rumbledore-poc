...
Beyond `pnpm test` and AUSPEX-fidelity per `DESIGN.md`, an **LLM-judge eval** on generated articles: *"Does this read as a real,
...
- **`02` Foundation** — design tokens, layouts, AUSPEX-fidelity per `DESIGN.md` (the later UI pass rides this).
